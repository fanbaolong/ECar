	...
	private static class EasingFunctions
	{
		...
		public static final EasingFunction EaseInElastic = new EasingFunction()
		{
			...
			public float getInterpolation(float input)
			{
				...
				return -((float) Math.pow(2.f, 10.f * (position -= 1.f)) * (float) Math.sin((position - s) * (2.f * Math.PI) / p));
			}
		};
		...
		public static final EasingFunction EaseOutElastic = new EasingFunction()
		{
			...
			public float getInterpolation(float input)
			{
				...
				float p = .3f;
				float s = p / (2 * (float) Math.PI) * (float) Math.asin(1.f);
				return (float) Math.pow(2, -10 * position) * (float) Math.sin((position - s) * (2.f * Math.PI) / p) + 1.f;
			}
		};
		...
		public static final EasingFunction EaseInOutElastic = new EasingFunction()
		{
			...
			public float getInterpolation(float input)
			{
				...
				if (position < 1.f)
				{
					return -.5f * ((float) Math.pow(2.f, 10.f * (position -= 1.f)) * (float) Math.sin((position * 1f - s) * (2.f * Math.PI) / p));
				}
				return (float) Math.pow(2.f, -10.f * (position -= 1.f)) * (float) Math.sin((position * 1f - s) * (2.f * Math.PI) / p) * .5f + 1.f;
			}
		};
