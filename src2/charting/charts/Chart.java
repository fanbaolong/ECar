...
public abstract class Chart<T extends ChartData<? extends DataSet<? extends Entry>>> extends ViewGroup implements ChartInterface
{
	 ...
	 * DOES NOT generate a callback to the OnChartValueSelectedListener.
	 *
	 * @param highlight
	...
	//
	// /**
	// * If set to true, value highlighting is enabled for all underlying data
	// of
	// * the chart which means that all values can be highlighted
	// programmatically
	// * or by touch gesture.
	// *
	// * @param enabled
	...
	/**
	 * Returns the total number of (y) values the chart holds (across all
	 * DataSets).
	 *
	 * @return
	 */
