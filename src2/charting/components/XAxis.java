...
public class XAxis extends AxisBase
{
	 ...
	 * by the computeAxis() methods in the renderers
	 */
	...
	/**
	 * Sets a custom XAxisValueFormatter for the data object that allows
	 * custom-formatting of all x-values before rendering them. Provide null to
	 * reset back to the default formatting.
	 *
	 * @param formatter
	 */
