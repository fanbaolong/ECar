...
public class Legend extends ComponentBase
{
	...
	{
		RIGHT_OF_CHART, RIGHT_OF_CHART_CENTER, RIGHT_OF_CHART_INSIDE, LEFT_OF_CHART, LEFT_OF_CHART_CENTER, LEFT_OF_CHART_INSIDE, BELOW_CHART_LEFT, BELOW_CHART_RIGHT, BELOW_CHART_CENTER, ABOVE_CHART_LEFT, ABOVE_CHART_RIGHT, ABOVE_CHART_CENTER, PIECHART_CENTER
	}
	...
	/**
	 * This method sets the automatically computed labels for the legend. Use
	 * setCustom(...) to set custom labels.
	 * 
	 * @param labels
	 */
	...
	public void calculateDimensions(Paint labelpaint, ViewPortHandler viewPortHandler)
	{
		...
		} else if (mPosition == LegendPosition.BELOW_CHART_LEFT || mPosition == LegendPosition.BELOW_CHART_RIGHT || mPosition == LegendPosition.BELOW_CHART_CENTER || mPosition == LegendPosition.ABOVE_CHART_LEFT || mPosition == LegendPosition.ABOVE_CHART_RIGHT || mPosition == LegendPosition.ABOVE_CHART_CENTER)
		{
