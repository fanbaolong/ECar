...
public class XAxisRendererHorizontalBarChart extends XAxisRendererBarChart
{
	...
	public void renderAxisLabels(Canvas c)
	{
		...
		if (mXAxis.getPosition() == XAxisPosition.TOP)
		{
			...
			drawLabels(c, mViewPortHandler.contentRight() + xoffset, new PointF(0.0f, 0.5f));

		} else if (mXAxis.getPosition() == XAxisPosition.TOP_INSIDE)
		{

			drawLabels(c, mViewPortHandler.contentRight() - xoffset, new PointF(1.0f, 0.5f));

		} else if (mXAxis.getPosition() == XAxisPosition.BOTTOM)
		{

			drawLabels(c, mViewPortHandler.contentLeft() - xoffset, new PointF(1.0f, 0.5f));

		} else if (mXAxis.getPosition() == XAxisPosition.BOTTOM_INSIDE)
		{

			drawLabels(c, mViewPortHandler.contentLeft() + xoffset, new PointF(0.0f, 0.5f));
	...
	public void renderGridLines(Canvas c)
	{
		...
		for (int i = mMinX; i <= mMaxX; i += mXAxis.mAxisLabelModulus)
		{
			...
			if (mViewPortHandler.isInBoundsY(position[1]))
			{
				...
				c.drawLine(mViewPortHandler.contentLeft(), position[1], mViewPortHandler.contentRight(), position[1], mGridPaint);
			}
		}
	}
