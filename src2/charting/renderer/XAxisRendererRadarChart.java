...
public class XAxisRendererRadarChart extends XAxisRenderer
{
	...
	public void renderAxisLabels(Canvas c)
	{
		...
		for (int i = 0; i < mXAxis.getValues().size(); i += mod)
		{
			...
			PointF p = Utils.getPosition(center, mChart.getYRange() * factor + mXAxis.mLabelRotatedWidth / 2f, angle);

			drawLabel(c, label, i, p.x, p.y - mXAxis.mLabelRotatedHeight / 2.f, drawLabelAnchor, labelRotationAngleDegrees);
		}
	}
