...
public class OrderPileAdapter extends AbsViewHolderAdapter<OrderPile>
{
	...
	public OrderPileAdapter(Activity context, int layoutRes)
	{
	...
	protected void bindData(int pos, final OrderPile itemData)
	{
		...
		tv_name.setText(itemData.getReSiteName());
		...
		tv_address.setText("地址：" + StringUtil.isNull(itemData.getReSitePositionName()));
		...
		tv_booktime.setText(StringUtil.isNull(itemData.getReServeTime()));
		//根据状态来判断按钮是否显示
